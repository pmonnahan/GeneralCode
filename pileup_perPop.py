...
for pop in Pops:
    ...
    sh_file.write('#!/bin/bash -e\n' +
                  ...
                  '#SBATCH --mem=' + args.mem + '\n' +
                  'source samtools-1.3\n' +
                  'samtools mpileup -C ' + args.C + ' -f ' + args. R + ' -o ' + args.o + pop + '.C' + args.C + '.pileup' + args.bamdir + pop + '1.sort.CRG.bam ' + args.bamdir + pop + '2.sort.CRG.bam ' + args.bamdir + pop + '3.sort.CRG.bam')
    sh_file.close()
